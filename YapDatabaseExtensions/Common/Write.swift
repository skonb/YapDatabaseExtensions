...
extension YapDatabaseReadWriteTransaction {
    ...
    */
    public func write<
        ...
        where
        Object: NSCoding,
        Object: Persistable>(object: Object, intoCollection collection: String) -> Object {
    ...
    */
    public func write<
        ...
        where
        ObjectWithObjectMetadata: NSCoding,
        ObjectWithObjectMetadata: ObjectMetadataPersistable>(object: ObjectWithObjectMetadata, intoCollection collection: String) -> ObjectWithObjectMetadata {
    ...
    */
    public func write<
        ...
        ObjectWithValueMetadata: ValueMetadataPersistable,
        ObjectWithValueMetadata.MetadataType.ArchiverType: NSCoding,
        ObjectWithValueMetadata.MetadataType.ArchiverType.ValueType == ObjectWithValueMetadata.MetadataType>(object: ObjectWithValueMetadata, intoCollection collection: String) -> ObjectWithValueMetadata {
    ...
    */
    public func write<
        ...
        Value: Persistable,
        Value.ArchiverType: NSCoding,
        Value.ArchiverType.ValueType == Value>(value: Value, intoCollection collection: String) -> Value {
    ...
    */
    public func write<
        ...
        ValueWithValueMetadata.ArchiverType.ValueType == ValueWithValueMetadata,
        ValueWithValueMetadata.MetadataType.ArchiverType: NSCoding,
        ValueWithValueMetadata.MetadataType.ArchiverType.ValueType == ValueWithValueMetadata.MetadataType>(value: ValueWithValueMetadata, intoCollection collection: String) -> ValueWithValueMetadata {
    ...
    */
    public func write<
        ...
        ValueWithObjectMetadata.MetadataType: NSCoding,
        ValueWithObjectMetadata.ArchiverType: NSCoding,
        ValueWithObjectMetadata.ArchiverType.ValueType == ValueWithObjectMetadata>(value: ValueWithObjectMetadata, intoCollection collection: String) -> ValueWithObjectMetadata {
...
extension YapDatabaseReadWriteTransaction {
    ...
    */
    public func write<
        ...
        Objects.Generator.Element == Object,
        Object: NSCoding,
        Object: Persistable>(objects: Objects, intoCollection collection: String) -> [Object] {
            return objects.map { self.write($0, intoCollection: collection) }
    }
    ...
    */
    public func write<
        ...
        Objects.Generator.Element == ObjectWithObjectMetadata,
        ObjectWithObjectMetadata: NSCoding,
        ObjectWithObjectMetadata: ObjectMetadataPersistable>(objects: Objects, intoCollection collection: String) -> [ObjectWithObjectMetadata] {
            return objects.map { self.write($0, intoCollection: collection) }
    }
    ...
    */
    public func write<
        ...
        ObjectWithValueMetadata: ValueMetadataPersistable,
        ObjectWithValueMetadata.MetadataType.ArchiverType: NSCoding,
        ObjectWithValueMetadata.MetadataType.ArchiverType.ValueType == ObjectWithValueMetadata.MetadataType>(objects: Objects, intoCollection collection: String) -> [ObjectWithValueMetadata] {
            return objects.map { self.write($0, intoCollection: collection) }
    }
    ...
    */
    public func write<
        ...
        Value: Persistable,
        Value.ArchiverType: NSCoding,
        Value.ArchiverType.ValueType == Value>(values: Values, intoCollection collection: String) -> [Value] {
            return values.map { self.write($0, intoCollection: collection) }
    }
    ...
    */
    public func write<
        ...
        ValueWithValueMetadata.ArchiverType.ValueType == ValueWithValueMetadata,
        ValueWithValueMetadata.MetadataType.ArchiverType: NSCoding,
        ValueWithValueMetadata.MetadataType.ArchiverType.ValueType == ValueWithValueMetadata.MetadataType>(values: Values, intoCollection collection: String) -> [ValueWithValueMetadata] {
            return values.map { self.write($0, intoCollection: collection) }
    }
    ...
    */
    public func write<
        ...
        ValueWithObjectMetadata.ArchiverType: NSCoding,
        ValueWithObjectMetadata.MetadataType: NSCoding,
        ValueWithObjectMetadata.ArchiverType.ValueType == ValueWithObjectMetadata>(values: Values, intoCollection collection: String) -> [ValueWithObjectMetadata] {
            return values.map { self.write($0, intoCollection: collection) }
    }
}
...
extension YapDatabaseConnection {
    ...
    */
    public func write<
        ...
        Object: NSCoding,
        Object: Persistable>(object: Object, intoCollection collection: String) -> Object {
            return write { $0.write(object, intoCollection: collection) }
    }
    ...
    */
    public func write<
        ...
        Value.ArchiverType: NSCoding,
        Value.ArchiverType.ValueType == Value>(value: Value, intoCollection collection: String) -> Value {
            return write { $0.write(value, intoCollection: collection) }
    }
...
extension YapDatabaseConnection {
    ...
    */
    public func asyncWrite<
        ...
        where
        Object: NSCoding,
        Object: Persistable>(object: Object, intoCollection collection: String, queue: dispatch_queue_t = dispatch_get_main_queue(), completion: (Object) -> Void) {
            asyncWrite({ $0.write(object, intoCollection: collection) }, queue: queue, completion: completion)
    }
    ...
    */
    public func asyncWrite<
        ...
        where
        ObjectWithObjectMetadata: NSCoding,
        ObjectWithObjectMetadata: ObjectMetadataPersistable>(object: ObjectWithObjectMetadata,intoCollection collection: String,  queue: dispatch_queue_t = dispatch_get_main_queue(), completion: (ObjectWithObjectMetadata) -> Void) {
            asyncWrite({ $0.write(object, intoCollection: collection) }, queue: queue, completion: completion)
    }
    ...
    */
    public func asyncWrite<
        ...
        where
        ObjectWithValueMetadata: NSCoding,
        ObjectWithValueMetadata: ValueMetadataPersistable>(object: ObjectWithValueMetadata, intoCollection collection: String, queue: dispatch_queue_t = dispatch_get_main_queue(), completion: (ObjectWithValueMetadata) -> Void) {
            asyncWrite({ $0.write(object, intoCollection: collection) }, queue: queue, completion: completion)
    }
    ...
    */
    public func asyncWrite<
        ...
        Value: Persistable,
        Value.ArchiverType: NSCoding,
        Value.ArchiverType.ValueType == Value>(value: Value, intoCollection collection: String, queue: dispatch_queue_t = dispatch_get_main_queue(), completion: (Value) -> Void) {
            asyncWrite({ $0.write(value, intoCollection: collection) }, queue: queue, completion: completion)
    }
    ...
    */
    public func asyncWrite<
        ...
        ValueWithValueMetadata.ArchiverType.ValueType == ValueWithValueMetadata,
        ValueWithValueMetadata.MetadataType.ArchiverType: NSCoding,
        ValueWithValueMetadata.MetadataType.ArchiverType.ValueType == ValueWithValueMetadata.MetadataType>(value: ValueWithValueMetadata, intoCollection collection: String, queue: dispatch_queue_t = dispatch_get_main_queue(), completion: (ValueWithValueMetadata) -> Void) {
            asyncWrite({ $0.write(value, intoCollection: collection) }, queue: queue, completion: completion)
    }
    ...
    */
    public func asyncWrite<
        ...
        ValueWithObjectMetadata.MetadataType: NSCoding,
        ValueWithObjectMetadata.ArchiverType: NSCoding,
        ValueWithObjectMetadata.ArchiverType.ValueType == ValueWithObjectMetadata>(value: ValueWithObjectMetadata, intoCollection collection: String, queue: dispatch_queue_t = dispatch_get_main_queue(), completion: (ValueWithObjectMetadata) -> Void) {
            asyncWrite({ $0.write(value, intoCollection: collection) }, queue: queue, completion: completion)
    }
}
...
extension YapDatabaseConnection {
    ...
    */
    public func write<
        ...
        Objects.Generator.Element == ObjectWithValueMetadata,
        ObjectWithValueMetadata: NSCoding,
        ObjectWithValueMetadata: ValueMetadataPersistable>(objects: Objects, intoCollection collection: String) -> [ObjectWithValueMetadata] {
            return write { $0.write(objects, intoCollection: collection) }
    }
    ...
    */
    public func write<
        ...
        ValueWithValueMetadata.MetadataType.ArchiverType: NSCoding,
        ValueWithValueMetadata.ArchiverType: NSCoding,
        ValueWithValueMetadata.ArchiverType.ValueType == ValueWithValueMetadata>(values: Values, intoCollection collection: String) -> [ValueWithValueMetadata] {
            return write { $0.write(values, intoCollection: collection) }
    }
...
extension YapDatabaseConnection {
    ...
    */
    public func asyncWrite<
        ...
        Objects.Generator.Element == Object,
        Object: NSCoding,
        Object: Persistable>(objects: Objects, intoCollection collection: String, queue: dispatch_queue_t = dispatch_get_main_queue(), completion: ([Object]) -> Void) {
    ...
    */
    public func asyncWrite<
        ...
        Objects.Generator.Element == ObjectWithObjectMetadata,
        ObjectWithObjectMetadata: NSCoding,
        ObjectWithObjectMetadata: ObjectMetadataPersistable>(objects: Objects,intoCollection collection: String,  queue: dispatch_queue_t = dispatch_get_main_queue(), completion: ([ObjectWithObjectMetadata]) -> Void) {
            asyncWrite({ $0.write(objects, intoCollection: collection) }, queue: queue, completion: completion)
    }
    ...
    */
    public func asyncWrite<
        ...
        Objects.Generator.Element == ObjectWithValueMetadata,
        ObjectWithValueMetadata: NSCoding,
        ObjectWithValueMetadata: ValueMetadataPersistable>(objects: Objects, intoCollection collection: String, queue: dispatch_queue_t = dispatch_get_main_queue(), completion: ([ObjectWithValueMetadata]) -> Void) {
            asyncWrite({ $0.write(objects, intoCollection: collection) }, queue: queue, completion: completion)
    }
    ...
    */
    public func asyncWrite<
        ...
        Value: Persistable,
        Value.ArchiverType: NSCoding,
        Value.ArchiverType.ValueType == Value>(values: Values, intoCollection collection: String, queue: dispatch_queue_t = dispatch_get_main_queue(), completion: ([Value]) -> Void) {
    ...
    */
    public func asyncWrite<
        ...
        ValueWithObjectMetadata.MetadataType: NSCoding,
        ValueWithObjectMetadata.ArchiverType: NSCoding,
        ValueWithObjectMetadata.ArchiverType.ValueType == ValueWithObjectMetadata>(values: Values, intoCollection collection: String, queue: dispatch_queue_t = dispatch_get_main_queue(), completion: ([ValueWithObjectMetadata]) -> Void) {
            asyncWrite({ $0.write(values, intoCollection: collection) }, queue: queue, completion: completion)
    }
    ...
    */
    public func asyncWrite<
        ...
        ValueWithValueMetadata.MetadataType: NSCoding,
        ValueWithValueMetadata.ArchiverType: NSCoding,
        ValueWithValueMetadata.ArchiverType.ValueType == ValueWithValueMetadata>(values: Values, intoCollection collection: String, queue: dispatch_queue_t = dispatch_get_main_queue(), completion: ([ValueWithValueMetadata]) -> Void) {
            asyncWrite({ $0.write(values, intoCollection: collection) }, queue: queue, completion: completion)
    }
}
...
extension YapDatabase {
    ...
    */
    public func write<
        ...
        where
        ObjectWithValueMetadata: NSCoding,
        ObjectWithValueMetadata: ValueMetadataPersistable>(object: ObjectWithValueMetadata, intoCollection collection: String) -> ObjectWithValueMetadata {
            return newConnection().write(object, intoCollection: collection)
    }
...
extension YapDatabase {
    ...
    */
    public func asyncWrite<
        ...
        ObjectWithValueMetadata: ValueMetadataPersistable,
        ObjectWithValueMetadata.MetadataType: Archiver,
        ObjectWithValueMetadata.MetadataType.ArchiverType.ValueType == ObjectWithValueMetadata.MetadataType>(objects: Objects, intoCollection collection: String, queue: dispatch_queue_t = dispatch_get_main_queue(), completion: ([ObjectWithValueMetadata]) -> Void) {
            newConnection().asyncWrite(objects, intoCollection: collection, queue: queue, completion: completion)
    }
